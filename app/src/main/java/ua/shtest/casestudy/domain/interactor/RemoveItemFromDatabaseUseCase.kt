...
class RemoveItemFromDatabaseUseCase @Inject constructor(
    private val itemDao: ItemDao,
    private val itemsMapper: ItemsMapper
) : UseCaseWithParameters<RemoveItemFromDatabaseUseCase.Params, Int>() {

    override fun execute(params: Params): Observable<Int> {
        return itemDao.delete(itemsMapper.map(params.item)).toObservable()
    }
